...
car_velocity_data = {60: {"total_speed": 0, "vehicle_count": 0}, 330: {"total_speed": 0, "vehicle_count": 0}}
motorcycle_velocity_data = {120: {"total_speed": 0, "vehicle_count": 0}, 260: {"total_speed": 0, "vehicle_count": 0}}
...
while running:
    ...
    pygame.draw.line(screen, WHITE, (410, 0), (410, height), 5)
    ...
    # Display average velocity for cars and motorcycles in the right side (x > 400)
    y_offset = 80  
