...
oval_coordinates = [
    ...
    (430,420), (590,420),#bus lane
    (490,420), (530,420), #bike lane 
...
#         # # Special logic for vehicles from (520, 790)
#         # if self.x == 520 and self.y >= 790:
#         #     south_light_color = dash_colors.get((600, 690), (255, 0, 0))  # South light
#         #     east_light_color = dash_colors.get((880, 590), (255, 0, 0))   # East light
#         #     west_light_color = dash_colors.get((400, 600), (255, 0, 0))   # West light

#         #     # Stop when east light is orange
#         #     if east_light_color == (255, 165, 0):
#         #         self.speed = 0  # Stop the vehicle
#         #     # Also stop if west light is green or orange 
#         #     elif (west_light_color in [(0, 255, 0), (255, 165, 0)]):
#         #         self.speed = 0  # Stop the vehicle
#         #     else:
#         #         # Resume movement in all other cases
...
#     # New logic for vehicles reaching (530, 590)
